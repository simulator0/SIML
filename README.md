...
![commtree](https://github.com/simulator0/SIML/blob/master/imgs/commtree.png)
...
The structure of the framework is outlined in the [Wiki](https://github.com/simulator0/SIML/wiki). Simulations regarding electrical power flow rather than energy balances (used in this tool), are conducted via file import/export to [OpenDSS](https://sourceforge.net/projects/electricdss/).

# Install

There are no installation requirements beside a functional [jupyter notebook](https://jupyter-notebook.readthedocs.io/en/stable/) (JPN) based on python3. You can start the juptyer notebook and review the template.

# Wiki

While the functions in the template are annotated, the [Wiki](https://github.com/simulator0/SIML/wiki) describes the workflow and explains the existing models/resources.
